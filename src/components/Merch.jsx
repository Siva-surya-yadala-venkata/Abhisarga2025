...
export default function Merch() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.85), rgba(0, 0, 0, 0.98)), url(${encodeURI("/MerchBg.webp")})`,
      }}
    >
      <ParallaxComponent backgroundImage="/Merch.webp" heading="Merchandise" />
