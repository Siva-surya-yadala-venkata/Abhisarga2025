...
const AboutPage = () => {
  return (
    <div className="relative min-h-screen h-[2vh] overflow-hidden flex items-center justify-center">
      ...
      {/* Content Layers */}
      <div className="relative z-10 w-full h-full flex flex-col items-center justify-center 2xl:flex-row 2xl:space-x-10 2xl:justify-between 2xl:text-left 2xl:space-y-0 space-y-8">
        {/* About Abhisarga Section */}
        <div className="w-[600px] h-[550px] p-8 flex flex-col items-center justify-center 2xl:w-[600px] 2xl:h-[550px] 2xl:items-start 2xl:justify-start 2xl:absolute 2xl:top-5 2xl:left-10">
          {/* Backdrop Layer for Abhisarga */}
          <div className="absolute inset-0 bg-black opacity-50 rounded-lg z-0"></div>

          <div className="relative z-10 flex flex-col text-center 2xl:text-left">
            <h1 className="text-[40px] 2xl:text-[80px] font-bold text-white leading-tight">
              <span
                style={{
                  color: "#F7E290",
          ...
          <div className="relative z-10 max-w-md space-y-4 text-gray-400 text-sm md:text-lg mt-6 text-[16px] text-center 2xl:text-left  md:text-[20px] 2xl:text-[22px]">
            <p>
        ...
        {/* About IIIT Section */}
        <div className="w-[650px] h-[500px] p-8 flex flex-col items-center justify-center 2xl:w-[650px] 2xl:h-[500px] 2xl:items-start 2xl:justify-start 2xl:absolute 2xl:bottom-5 2xl:right-10">
