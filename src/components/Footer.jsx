    ...
    <footer className="bg-[#24222d] text-[#f5e0a9] flex flex-wrap justify-between items-end relative">
      ...
      <div className="center flex flex-col items-center text-center relative z-10">
        ...
        <div className="social-media flex space-x-4 mt-4">
          {/* Social Media Icons */}
          <a
            href="https://www.instagram.com/abhisarga"
          ...
          <a href="https://www.linkedin.com/company/abhisarga-iiits/" aria-label="LinkedIn">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4 md:h-5 md:w-5"
              fill="#AE8E48"
          ...
          <a href="https://www.youtube.com/@abhisarga" aria-label="YouTube">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4 md:h-5 md:w-5"
              fill="#AE8E48"
          ...
          <a href="https://x.com/Abhisarga_iiits">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4 md:h-5 md:w-5"
              fill="#AE8E48"
